...
- It can be useful to know how many observations (rows) were used.

- This can be calculated using the `n()` function.
...
- Note that all columns are now numeric and can be used to perform calculations.
